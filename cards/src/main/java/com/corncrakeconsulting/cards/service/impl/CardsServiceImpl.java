package com.corncrakeconsulting.cards.service.impl;
...
import com.corncrakeconsulting.cards.exception.CardAlreadyExistsException;
import com.corncrakeconsulting.cards.exception.ResourceNotFoundException;
import com.corncrakeconsulting.cards.mapper.CardsMapper;
import com.corncrakeconsulting.cards.repository.CardsRepository;
...
public class CardsServiceImpl implements ICardsService {
    ...
    private Cards createNewCard(String mobileNumber) {
        ...
        long randomCardNumber = 100000000000L + ThreadLocalRandom.current().nextInt(900000000); // Use nextInt for integers
