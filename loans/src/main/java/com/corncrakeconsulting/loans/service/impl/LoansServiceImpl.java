package com.corncrakeconsulting.loans.service.impl;

import com.corncrakeconsulting.loans.constants.LoansConstants;
import com.corncrakeconsulting.loans.dto.LoansDto;
import com.corncrakeconsulting.loans.entity.Loans;
import com.corncrakeconsulting.loans.exception.LoanAlreadyExistsException;
import com.corncrakeconsulting.loans.exception.ResourceNotFoundException;
import com.corncrakeconsulting.loans.mapper.LoansMapper;
import com.corncrakeconsulting.loans.repository.LoansRepository;
...
public class LoansServiceImpl implements ILoansService {
    ...
    private Loans createNewLoan(String mobileNumber) {
        ...
        long randomLoanNumber = 100000000000L + ThreadLocalRandom.current().nextLong(900000000);
